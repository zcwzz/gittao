	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<tr class="text-c">
                ...
                <a style="text-decoration:none" class="ml-5" onClick="part_info('查看兼职详情','<?= Url::to(['meraudit/part-info']) ?>','10001','600','270')" href="javascript:;" title="查看兼职详情"><i class="Hui-iconfont">&#xe695;</i></a>
...
/*查看兼职详情*/
function part_info(title,url,id,w,h){
