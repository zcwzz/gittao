...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 学生审核管理 <span class="c-gray en">&gt;</span> 基本信息审核 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<tr class="text-c">
                ...
                <a title="查看基本信息" href="javascript:;" onclick="base_info('查看基本信息','<?= Url::to(['studentaudit/base-info']) ?>','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe60c;</i></a> 
                
                <a style="text-decoration:none" class="ml-5" onClick="cart_info('查看证件信息','<?= Url::to(['studentaudit/card-info']) ?>','10001','600','270')" href="javascript:;" title="查看证件信息"><i class="Hui-iconfont">&#xe695;</i></a> 
...
/*查看基本信息*/
function base_info(title,url,id,w,h){
	layer_show(title,url,w,h);
}
/*查看证件信息*/
function cart_info(title,url,id,w,h){
	layer_show(title,url,w,h);	
}
/*用户-删除*/
