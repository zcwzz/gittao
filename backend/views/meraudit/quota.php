	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<tr class="text-c">
                ...
                <a style="text-decoration:none" class="ml-5" onClick="quota_info('查看申请限额详情','<?= Url::to(['meraudit/quota-info']) ?>','10001','600','270')" href="javascript:;" title="查看申请限额详情"><i class="Hui-iconfont">&#xe695;</i></a>
...
/*查看限额申请详情*/
function quota_info(title,url,id,w,h){
