...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 数据统计 <span class="c-gray en">&gt;</span> 学生数据统计 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
    <div class="text-c"> 
        <span class="select-box inline">
		<select name="" class="select">
			<option value="0">学生性别</option>
			<option value="2">学生购物数</option>
            <option value="3">学生兼职数</option>
		</select>
		</span>
        <span class="select-box inline">
		<select name="" class="select">
