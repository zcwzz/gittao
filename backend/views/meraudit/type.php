...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 商家审核管理 <span class="c-gray en">&gt;</span> 类型申请 <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<tr class="text-c">
                ...
                <a style="text-decoration:none" class="ml-5" onClick="type_info('类型申请详情','<?= Url::to(['meraudit/type-info']) ?>','10001','600','270')" href="javascript:;" title="类型申请详情"><i class="Hui-iconfont">&#xe695;</i></a>
...
/*查看限额申请详情*/
function type_info(title,url,id,w,h){
